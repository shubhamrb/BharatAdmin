...
public abstract class MaterialScrollBar<T> extends RelativeLayout {
    ...
    MaterialScrollBar(Context context, RecyclerView recyclerView, boolean lightOnTouch) {
        ...
        setRightToLeft(ScrollUtil.isRightToLeft(context)); //Detects and applies the Right-To-Left status of the app
    ...
    View setUpHandleTrack(Context context) {
        ...
        LayoutParams lp = new LayoutParams(ScrollUtil.getDP(14, this), LayoutParams.MATCH_PARENT);
    ...
    Handle setUpHandle(Context context, Boolean lightOnTouch) {
        ...
        handleThumb.rtl = rtl;
        LayoutParams lp = new LayoutParams(ScrollUtil.getDP(18, this),
                ScrollUtil.getDP(72, this));
        lp.addRule(rtl ? ALIGN_PARENT_LEFT : ALIGN_PARENT_RIGHT);
    ...
    protected void onAttachedToWindow() {
        ...
        if(seekId != 0) {
            try {
                recyclerView = (RecyclerView) ScrollUtil.findNearestNeighborWithID(seekId, this);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int desiredWidth = ScrollUtil.getDP(18, this);
    ...
    protected void onDown(MotionEvent event) {
        ...
        int bottom = recyclerView.getHeight() - ScrollUtil.getDP(72, recyclerView.getContext());
    ...
    protected boolean validTouch(MotionEvent event) {
        return draggableFromAnywhere || (event.getY() >= handleThumb.getY() - ScrollUtil.getDP(20, recyclerView.getContext()) && event.getY() <= handleThumb.getY() + handleThumb.getHeight());
    }
