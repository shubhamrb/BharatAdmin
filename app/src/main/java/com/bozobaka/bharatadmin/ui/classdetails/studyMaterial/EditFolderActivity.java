...
public class EditFolderActivity extends BaseActivity {
    ...
    private void initUI() {
        ...
        toolbarText.setText(getResources().getString(R.string.text_edit_folder));
        etFolderName.setText(studyMaterialModel.getStudyMaterialName());
        btnCreateFolder.setOnClickListener(view -> editFolder());
    ...
    private void editFolder() {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            batch.update(documentReference, "studyMaterialName", folderName);
            batch.commit()
